...
public class SecurityConfig {
    ...
    // Added @Lazy to break the circular dependency initialization loop cleanly
    ...
    // Fixes the empty list bug by linking your actual database roles to user authorities mapping
    @Bean
